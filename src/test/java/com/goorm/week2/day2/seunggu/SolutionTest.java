...
import static com.goorm.week2.day2.seunggu.Solution.solution;
...
@DisplayName("구름 깃발 찾기 - 승구")
class SolutionTest {

    @Test
    @DisplayName("구름 깃발 찾기 테스트 케이스1")
    void test_case_1() throws IOException {
        BufferedReader reader = TestFileUtil.getReader(this.getClass(), "testcase/week2/day2/test_case1.txt");
        int solution = solution(reader);
        assertEquals(getInt(TestFileUtil.getReader(this.getClass(), "testcase/week2/day2/answer1.txt")), solution);
    }
    @Test
    @DisplayName("구름 깃발 찾기 테스트 케이스2")
    void test_case_2() throws IOException {
        ...
        int solution = solution(reader);
        assertEquals(getInt(TestFileUtil.getReader(this.getClass(), "testcase/week2/day2/answer2.txt")), solution);
    }
}