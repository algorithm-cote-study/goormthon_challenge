...
@DisplayName("완벽한 햄버거 만들기")
class SolutionTest {
    @Test
    @DisplayName("완벽한 햄버거 만들기 테스트 케이스1")
    void test_case_1() throws IOException {
        BufferedReader reader = TestFileUtil.getReader(this.getClass(), "week1/day4/test_case1.txt");
    ...
    void test_case_2() throws IOException {
        BufferedReader reader = TestFileUtil.getReader(this.getClass(), "week1/day4/test_case2.txt");
        int solution = Solution.solution(reader);
